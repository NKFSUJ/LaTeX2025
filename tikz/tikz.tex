...
\begin{frame}{Prezentacja}{}
    ...
    \url{https://github.com/NKFSUJ/LaTeX2025/tree/master/tikz/tikz.pdf}

    \vspace{0.5cm}

    \scalebox{1.5}{\qrcode{https://github.com/NKFSUJ/LaTeX2025/tree/master/tikz/tikz.pdf}}
\end{frame}
...
\onslide<2->\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{tikz/Zrzut_ekranu_2024-11-29_120331.png}
\end{figure}
...
\begin{frame}{...}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{tikz/Zrzut_ekranu_2024-11-29_125324.png}
...
\begin{frame}{...}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{tikz/Zrzut_ekranu_2024-11-29_130423.png}
...
\begin{frame}{...}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{tikz/Zrzut_ekranu_2024-11-29_132732.png}
        \caption{Z tego \texttt{pdf}a się uczyłem\footnote{\sout{tydzień} rok temu}, i z niego będę uczył was}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Grubość linii}
\verb|\draw[...] (0,0) -- (1,0);|
...
\begin{frame}[fragile]{Style linii}{}
...
\begin{frame}[fragile]{Trochę przykładów}{}
    
    \begin{lstlisting}
\begin{tikzpicture}
    \draw[very thick, red, fill=cyan, dotted, double] (0,0) -- (1,2) -- (2,2) -- (2,0) -- cycle;
    \draw[thin, green!20!black, fill=yellow, draw opacity = 0.8, fill opacity = 0.5, densely dashed]
        (1,1) -- ++(1,2) -- ++(1,0) -- ++(0,-2) -- cycle;
\end{tikzpicture}
    \end{lstlisting}
...
\begin{tikzpicture}
\coordinate (A) at (0,0);
    \draw[thick, green, fill=yellow] (A) ellipse(sqrt(2) and sin(90)) ;
\end{tikzpicture}
\end{lstlisting}
\begin{tikzpicture}
\coordinate (A) at (0,0);
...
\begin{frame}[fragile]{Ł:u:k:i}{}
\begin{columns}
\column{0.5\textwidth}
\begin{lstlisting}
\begin{tikzpicture}
    \draw[->, dashed, fill=orange, very thick] (3,0) arc (0:90:3cm);
\end{tikzpicture}
\end{lstlisting}
\begin{tikzpicture}
    \draw[->, dashed, fill=orange, very thick] (3,0) arc (0:90:3cm);
...
\begin{lstlisting}
\begin{tikzpicture}
    \draw[<->, thick, orange] (3,0) arc (180:390:2cm) -- (5,0) -- cycle;
\end{tikzpicture}
\end{lstlisting}
\begin{tikzpicture}
    \draw[<->, thick, orange] (3,0) arc (180:390:2cm) -- (5,0) -- cycle;
...
\draw[->] (0,0) -- (-1.8,-1.8) node[midway, above left] {tak};
\draw[->] (0,0) -- (1.8,-1.8) node[midway, above right] {nie};
\end{tikzpicture}

\caption{coś dla informatyków}
...
% Rysujemy strukturę ręcznie
\draw[thick, \cola] (0,0) -- (1,0) -- (1.5,0.866) -- (1,1.732) -- (0,1.732) -- (-0.5,0.866) -- cycle;
...
% Grupy metylowe (pokolorowane)
\node[text=\cola] at (-1,0.5) {CH$_3$};
\node[text=\colb] at (1.5,-0.5) {CH$_3$};
\node[text=\colc] at (3,0.5) {CH$_3$};

% Wiązania do grup metylowych
\draw[thick, \colc] (-0.5,0.866) -- (-0.8,0.866);
\draw[thick, \colb] (1.5,0) -- (1.5,-0.3);
\draw[thick, \cola] (2.5,0.866) -- (2.8,0.866);

% Legenda
% \node[text=\cola, anchor=west] at (4,1) {N1-metylowa};
% \node[text=\colb, anchor=west] at (4,0.5) {N3-metylowa};
% \node[text=\colc, anchor=west] at (4,0) {N7-metylowa};
% \node at (1.5,-1.5) {Uproszczony wzór kofeiny};

\end{tikzpicture}
    

\caption{natalka mnie zabije jak to zobaczy}
...
\begin{tikzpicture}
    \def\F{3}      % Dlugosc wektora sily F
...
\end{tabular}
     ...
     \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{tikz/Zrzut_ekranu_2024-12-07_111654.png}
...
\centering
    \begin{tikzpicture}
      \duck[parrot, body=gray!30!yellow, head=gray!30!yellow, bill=red, torch=gray!70!brown, tshirt=white!20!black, strawhat=brown!50!white, ribbon=gray, bowtie=green!50!white]
