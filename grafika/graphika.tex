...
{\small
    ...
    \begin{figure}
        \centering
        \includegraphics[trim={1cm 1cm 0 0}, clip,width=0.75\linewidth]{mem13}
        \verb|\includegraphics[trim={1cm 1cm 0 0}, clip, width=0\linewidth]{majonez.png}|
    \end{figure}
    \begin{figure}
        \centering
        \includegraphics[trim={1cm 0cm 10cm 2cm}, clip,width=0.5\linewidth]{mem13}
        \verb|\includegraphics[trim={1cm 0cm 10cm 2cm}, clip, width=0\linewidth]{majonez.png}|
    \end{figure}
}
    \end{columns} 
\end{frame}
