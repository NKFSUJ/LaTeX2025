...
\fill[brown!70!black] (0.5,1.65-3.9) circle (0.25);
  \duck[
  ...
  \fill[brown!70!black] (1.3,1.6-3.9) circle (0.25);

      \duck[
        body=brown!50!black,           % Kolor skóry
        bill=orange!70!black,    % Dziób (lekko przyciemniony, by pasował)
        ...
        xshift=4cm, yshift=-3.9cm
    ]
    
\node[align=center] at (3,-0.9) {\huge May the \LaTeX \\
  \huge be with you};
