...
\begin{minipage}[t]{0.5\linewidth}
    {\centering \bf Piątek, 12 grudnia\par}
    \begin{itemize}
        \item wprowadzenie
        \item podstawy
...
\end{minipage}
\begin{minipage}[t]{0.5\linewidth}
    {\centering \bf Sobota, 13 grudnia\par}
    \begin{itemize}
        \item prezentacje
        \item tabele
        \item tikz (rysunki i kaczki)
        \item tryb chemiczny
        \item obwody elektryczne
    \end{itemize}
\end{minipage}
% \end{columns}
}
...
\begin{subcolumns}
    ...
    \block{więcej info}{
        \centering
        \qrcode[height=5cm]{http://tiny.cc/latex25info}\\
        {\footnotesize \texttt{tiny.cc/latex25info}}
    }
    \subcolumn{0.35}
    \block{zapisy}{
        \centering
        \qrcode[height=5cm]{http://tiny.cc/latex25zapisy}\\
        {\footnotesize \texttt{tiny.cc/latex25zapisy}}
    }
\end{subcolumns}
