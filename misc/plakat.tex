\documentclass[20pt,a2paper]{tikzposter}
...
\definebackgroundstyle{samplebackgroundstyle}{
    ...
    \draw[line width=0pt, bottom color=backgroundcolor, top      color=backgroundcolor!60!white] (bottomleft) rectangle (topright); 
    \newcommand{\xsize}{7}
    \newcommand{\ysize}{8}
    \foreach \i in {1,...,56}
    {
...
% \colorlet{backgroundcolor}{violet}
\usecolorstyle[colorOne=violet]{Sweden}

\title{{\centering \scalebox{1.5}{Warsztaty \LaTeX{}a}}}
\author{$\bra{N}$aukowe $\hat{K}$oło $\ket{F}$izyków \& {Koło Matematyczno--Przyrodnicze}}
\date{\today}
...
\colorlet{titlebgcolor}{violet!80!white}
\colorlet{framecolor}{violet!60!white!45!white}
\maketitle
...
% }
    ...
    \innerblock{Wady}{\centering \textbullet\ brak\vspace{80pt}}
    \end{minipage}
    % \vfill
    % \end{subcolumns}
    }
...
\begin{minipage}[t]{0.25\linewidth}
    ...
    \duck[santa, beard=white!80!brown,
        xshift=3cm, scale=3, yshift=-0.5cm]
    % }
\end{minipage}
}
